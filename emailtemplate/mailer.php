...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $userTemplate = file_exists("emailtemplate/emailtemplate.html") ? file_get_contents("emailtemplate/emailtemplate.html") : "Thank you for contacting us, {{name}}!";
    $adminTemplate = file_exists("emailtemplate/admin_template.html") ? file_get_contents("emailtemplate/admin_template.html") : "New inquiry from {{name}}.\nMessage: {{message}}";
